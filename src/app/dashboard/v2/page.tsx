...
const APPS = [
  ...
  { label: "Sequences",   href: "/dashboard/sequences",    color: "#888" },
  ...
  { label: "Reports",     href: "/dashboard/reports",      color: "#888" },
...
function APP_ICON({ name, color }: { name: string; color: string }) {
  ...
  const icons: Record<string, React.ReactNode> = {
    ...
    "Sequences":    <><circle cx="5" cy="6" r="2" {...s}/><circle cx="12" cy="12" r="2" {...s}/><circle cx="19" cy="18" r="2" {...s}/><path d="M6.5 7.5l4 3M13.5 13.5l4 3" {...s}/></>,
    "Reports":      <><path d="M3 3v18h18" {...s}/><path d="M7 15l4-4 3 3 5-6" {...s}/></>,
