  ...
  return (
    <main className="min-h-screen bg-[#0c0c0c] text-white flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center text-center px-6 py-32">
        ...
        <h1 className="text-[clamp(40px,6vw,80px)] font-black tracking-tight leading-none uppercase mb-8">Listing Photos</h1>
        <p className="text-[#666] text-lg max-w-lg mb-12 leading-relaxed">Professional photography that makes every listing stand out. Sharp, well-lit images that move properties faster.</p>
